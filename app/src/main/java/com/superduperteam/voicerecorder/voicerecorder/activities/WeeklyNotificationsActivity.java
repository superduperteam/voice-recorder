...
public class WeeklyNotificationsActivity extends BaseActivity implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener{
...
//        setContentView(R.layout.activity_recording_player);
        ...
        View contentView = inflater.inflate(R.layout.activity_weekly_notifications, null, false);
        ...
        mMonthChangeListener= new MonthChangeListener() {
            @Override
        ...
        mEventLongPressListener = new EventLongPressListener() {
            @Override
